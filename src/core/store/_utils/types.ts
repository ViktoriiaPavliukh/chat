...
// Action creators
export type IActionCreator<T extends string> = (() => IAction<T>) &
  IActionType<T>;

export type IPayloadActionCreator<T extends string, P> = ((
  payload: P
) => IPayloadAction<T, P>) &
  IActionType<T>;

export type IErrorActionCreator<T extends string, E> = ((
  error: E
) => IErrorAction<T, E>) &
  IActionType<T>;
